! function (l) {
    ...
    function n(a) {
        var c, b, d, e = "";
        return c = String(parseInt(a / 3600, 10)), b = String(parseInt(a % 3600 / 60, 10)), d = String(parseInt(a % 60, 10)), "0" != c && (1 == c.length && (c = "0" + c), e += c + ":"), 1 == b.length &&
            (b = "0" + b), e += b + ":", 1 == d.length && (d = "0" + d), e + d
    }
    ...
    function p(a) {
        ...
        (this.musicLength = this.musicList.length) && f("body") || (this.musicDom.listWrap.innerHTML = "<p>暂无播放记录...</p>");
        this.audioDom = null;
        this.init()
    }
    var m = null,
        q =parseInt(Math.random()*55+1);
    p.prototype = {
        config: {
            musicList: [],
            defaultVolume: .7,
        ...
        createListDom: function () {
            var a = 0,
                c = "<ul>";
            for (a; a <
                this.musicLength; a++) c += '<li class="f-toe"><strong>' + this.musicList[a].title + "</strong> -- <small>" + this.musicList[a].singer + "</small></li>";
        ...
        resetPlayer: function (a) {
            ...
            this.musicDom.title.innerHTML = "<strong>" + c.title + "</strong><small>" + c.singer +
                "</small>";
        ...
        action: function () {
            ...
            c.volumeControl.addEventListener("click", function (b) {
                b = b ||
                    window.event;
                b.stopPropagation();
            ...
            c.volumeEventer.addEventListener("click", function (b) {
                b = b || window.event;
                b.stopPropagation();
                var c =
                    this.offsetHeight;
            ...
            var d = document.querySelectorAll(".m-music-list-wrap li"),
                e = 0;
            for (e; e < this.musicLength; e++) ! function (b) {
                d[b].addEventListener("click", function () {
                    a.resetPlayer(b)
                }, !1)
            }(e);
            b.ctrl.addEventListener("click", function () {
            ...
            b.listCircular.addEventListener("click", function () {
                h(this, "current");
                g(b.singleCircular, "current");
                g(b.randomPlay, "current");
                a.playMode = 1
            });
            b.randomPlay.addEventListener("click", function () {
                h(this, "current");
                g(b.singleCircular, "current");
                g(b.listCircular, "current");
                a.playMode = 2
            });
            b.singleCircular.addEventListener("click", function () {
                h(this, "current");
                g(b.listCircular, "current");
                g(b.randomPlay, "current");
                a.playMode = 3
